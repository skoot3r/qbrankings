(function(){
  ...
  document.getElementById('reset').onclick=()=>{if(!confirm('Reset the editor to the original QB Board seed? This does not delete anything from Supabase.'))return;d=JSON.parse(JSON.stringify(QB_SEED));selected=0;render()};
